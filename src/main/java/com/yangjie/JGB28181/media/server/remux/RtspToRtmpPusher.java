...
//        record.setVideoCodec(AV_CODEC_ID_H264);
    ...
    public RtspToRtmpPusher go(Thread nowThread)
        ...
        ProcessBuilder pb = new ProcessBuilder(ffmpeg, cameraPojo.getRtsp(), "-y", "-vsync", "0", "-hwaccel", "cuvid", "-c:v", "h264_cuvid", "-i", "rtsp://admin:a12345678@203.88.202.226:554/h264/ch1/main/av_stream", "-f", "flv", "-c:v", "h264_nvenc", "-vf", "npp_scale=1280:720", "rtmp://127.0.0.1:1935/live");
        try {
