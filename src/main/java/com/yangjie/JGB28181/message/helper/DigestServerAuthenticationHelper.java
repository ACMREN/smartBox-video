...
public class DigestServerAuthenticationHelper  {
    ...
    public String MD5AuthenticateHeader(Response response, String userName, String method, String uri, String pass) {
        WWWAuthenticateHeader authHeader = (WWWAuthenticateHeader) response.getHeader(WWWAuthenticate.NAME);
